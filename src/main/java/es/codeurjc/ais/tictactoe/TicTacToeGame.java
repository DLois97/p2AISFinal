...
public class TicTacToeGame {
	...
	public boolean mark(int cellId/*,StatisticsService statisticsService*/) {
...
//				System.out.println("las estadisticas existen");
//			} else {
//				System.out.println("las estadisticas no existen");
//			}
//			System.out.println(""+statisticsService.getEstadisticas().size());
			if (res.win) {
				...
				winner.pos = res.pos;				
//				statisticsService.aumentarEstadisticas(this.players.get(this.currentTurn).getName(),0);
//				System.out.println(""+statisticsService.getEstadisticas().size());
//				statisticsService.aumentarEstadisticas(this.players.get((this.currentTurn+1)%2).getName(),1);
				this.sendEvent(EventType.GAME_OVER, winner);

			} else if (this.checkDraw()) {

				this.sendEvent(EventType.GAME_OVER, null);
//				statisticsService.aumentarEstadisticas(this.players.get(this.currentTurn).getName(),2);
//				statisticsService.aumentarEstadisticas(this.players.get((this.currentTurn+1)%2).getName(),2);
